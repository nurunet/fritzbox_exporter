...
COPY https://github.com/nurunet/fritzbox_exporter/blob/master/metrics.json https://github.com/nurunet/fritzbox_exporter/blob/master/metrics-lua_cable.json /app/
